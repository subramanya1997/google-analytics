...
async def get_ingestion_schedule(
    ...
    2. If not found, get from database (tenants.data_ingestion_schedule)
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Failed to get data_ingestion_schedule from database: {db_error}")
        ...
        cron_expression = cron_from_db or _settings.DATA_INGESTION_CRON
